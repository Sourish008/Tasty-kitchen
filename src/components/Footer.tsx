...
const Footer = () => {
  return (
    <footer className="bg-surface-dark text-text-muted pt-16 pb-8 border-t border-[var(--border-color)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-text-muted hover:text-white transition-colors"><Facebook size={20} /></a>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/special" className="hover:text-primary-500 transition-colors">Today's Specials</Link></li>
              <li><Link to="/reviews" className="hover:text-primary-500 transition-colors">Customer Reviews</Link></li>
              <li><Link to="/account" className="hover:text-primary-500 transition-colors">My Account</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-gray-800 text-sm text-center md:flex justify-between items-center">
